...
module.exports = function makeWebpackConfig() {
  ...
  if (!isTest) {
    ...
    config.entry = isTest ? {} : {
      ...
      // 'app': './src/main.ts' // our angular app
        'appone': './src/appone/main.ts',
        'apptwo': './src/apptwo/main.ts'
    };
  }
  ...
  config.module = {
    rules: [
      ...
      {
        test: /\.css$/,
        exclude: root('src', 'appone'),
        loader: isTest ? 'null-loader' : ExtractTextPlugin.extract({ fallback: 'style-loader', use: ['css-loader', 'postcss-loader']})
      },
      {
        test: /\.css$/,
        exclude: root('src', 'apptwo'),
        loader: isTest ? 'null-loader' : ExtractTextPlugin.extract({ fallback: 'style-loader', use: ['css-loader', 'postcss-loader']})
      },
      // all css required in src/app files will be merged in js files
      {test: /\.css$/, include: root('src', 'appone'), loader: 'raw-loader!postcss-loader'},
      {test: /\.css$/, include: root('src', 'apptwo'), loader: 'raw-loader!postcss-loader'},
